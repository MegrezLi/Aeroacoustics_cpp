...
C++ engineering example: dt=0.0015625; optional controller, gridded wind and propagation via CLI
---------------------- SIMULATION CONTROL --------------------------------------
True          Echo            - Echo input data to <RootName>.ech (flag)
"FATAL"       AbortLevel      - Error level when simulation should abort (string) {"WARNING", "SEVERE", "FATAL"}
         20   TMax            - Total run time (s)
    0.0015625   DT              - Recommended module time step (s)
...
1.81206E-05   KinVisc         - Kinematic viscosity of working fluid (m^2/s)
        343   SpdSound        - Speed of sound in working fluid (m/s)
...
---------------------- INPUT FILES ---------------------------------------------
"../IEA_LB_RWT-AeroAcoustics/RotorSE_FAST_IEA_landBased_RWT_ElastoDyn.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"../IEA_LB_RWT-AeroAcoustics/RotorSE_FAST_IEA_landBased_RWT_InflowFile.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"../IEA_LB_RWT-AeroAcoustics/RotorSE_FAST_IEA_landBased_RWT_AeroDyn.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"../IEA_LB_RWT-AeroAcoustics/RotorSE_FAST_IEA_landBased_RWT_ServoDyn.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
